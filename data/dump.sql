...
CREATE TABLE `motivo_assistir` (
  ...
  PRIMARY KEY (`id`),
  KEY `motivo_assistir_idx` (`id_serie`),
  CONSTRAINT `serie_motivo` FOREIGN KEY (`id_serie`) REFERENCES `serie` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `serie` (
  ...
  PRIMARY KEY (`id`),
  KEY `categoria_serie_idx` (`id_categoria`),
  CONSTRAINT `categoria_serie` FOREIGN KEY (`id_categoria`) REFERENCES `serie` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-05 11:29:32
